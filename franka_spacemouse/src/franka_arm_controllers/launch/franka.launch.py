    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[
                ...
                {
                    "arm_mounting_orientation": [
                        float(x) for x in arm_mounting_orientation.strip("[]").split(",")
                    ]
                },
            ],
        ...
        Node(
            ...
            condition=IfCondition(LaunchConfiguration("spawn_franka_robot_state_broadcaster")),
            output="screen",
        ),
...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument(
            ...
            default_value="false",
            description="Spawn franka_robot_state_broadcaster (disable by default to avoid RT publisher lock failures).",
        ),
    ]
